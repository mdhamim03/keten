@extends('layouts.frontendCategoryLayout')
@section('content')
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post post-grid rounded bordered">
                                <div class="thumb top-rounded">
                                    <a href="category.html" class="category-badge position-absolute">{{$post->category->title}}</a>
                                ...
                                <div class="details">
                                    <ul class="meta list-inline mb-0">
                                        <li class="list-inline-item"><a href="category.html#"><img style="width:50px;height:50px;border-radius:50%;" src="{{$post->user->profile_img_url ?$post->user->profile_img_url : env('AVATER_API').$post->user->name}}" class="author" alt="author"/>{{$post->user->name}}</a></li>
                                        <li class="list-inline-item">{{Carbon\Carbon::parse($post->created_at)->format('d M Y')}}</li>
                                    </ul>
                                    <h5 class="post-title mb-3 mt-3"><a href="{{route('blog.post.details',$post->slug)}}">{{$post->title}}</a></h5>
