                    ...
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner data-bg-image" data-bg-image="">
								<img src="{{$popularPost->featured_img_url}}" alt="">
							</div>
                        </div>
                    </a>
                </div>
				...
				<div class="col-lg-8">
					...
					<div class="post post-classic rounded bordered">
						<div class="thumb top-rounded">
							...
							<a href="blog-single.html">
								<div class="inner">
									<img src="{{$post->featured_img_url}}" alt="post-title" />
								</div>
							</a>
						</div>
						<div class="details">
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="classic.html#"><img style="width: 50px;height:50px;border-radius:50%;" src="{{$post->user->profile_img_url ? $post->user->profile_img_url : env('AVATER_API').$post->user->name}}" class="author" alt="author"/>{{$post->user->name}}</a></li>
							...
							<div class="widget-content">
								...
								<div class="post post-list-sm circle">
									<div class="thumb circle">
										...
										<a href="blog-single.html">
											<div class="inner">
												<img style="width: 50px;height:50px" src="{{$popularPost->user->profile_img_url ? $popularPost->user->profile_img_url : env('AVATER_API').$popularPost->user->name}}" alt="post-title" />
											</div>
										</a>
									</div>
									<div class="details clearfix">
										<h6 class="post-title my-0"><a href="blog-single.html">{{$popularPost->title}}</a></h6>
